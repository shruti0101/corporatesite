...
const handleSubmit = async (e) => {
  ...
  return (
    ...
    <section className="relative w-full h-[60vh]  md:h-[35vh]  lg:h-[70vh] bg-[#1A4D6E] flex items-center overflow-hidden">
      ...
      {/* Background Circles */}
      <div className="absolute right-[-100px] top-[-80px] w-[400px] h-[400px] overflow-hidden bg-white/5 rounded-full"></div>
      <div className="absolute right-[140px] bottom-[10px] w-[300px] h-[300px] overflow-hidden bg-white/5 rounded-full"></div>
