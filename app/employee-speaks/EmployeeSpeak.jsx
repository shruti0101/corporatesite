          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              {testimonials.map((item, i) => (
                <SwiperSlide key={i}>
                  <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 md:p-6 h-[310] flex flex-col">
                    {/* Quote */}
