...
const growth = [
  ...
  return (
      ...
      <div className=" px-6 md:px-12">
       ...
       Straight From the Hearts of Our Team
          ...
          <p className="text-white/80 text-2xl leading-relaxed max-w-2xl">
            Don't take our word for it — hear from the people who make Inquiry Bazaar the place it is every single day.
          </p>
   ...
   <section className="bg-[#F7F6F2] py-16 px-6 md:px-16">
  ...
  <div className="max-w-7xl mx-auto">
    ...
    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
      {growth.map((item, i) => (
        ...
        >
          {/* Icon Box */}
          <div className="w-12 h-12 flex items-center justify-center rounded-xl bg-gray-100 mb-4 text-xl">
            {item.icon}
          </div>
