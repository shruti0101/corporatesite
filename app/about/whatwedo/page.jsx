export default function WhatWeDo() {
  return (
    <>
      <section className="w-full bg-[#1A4D6E] pt-6 md:pt-16 px-6 md:px-24">
        ...
        {/* Heading */}
        <h1 className="text-[44px] md:text-[64px] leading-12 md:leading-[1.1]  text-white font-semibold tracking-[-0.5px] mb-3 md:mb-5">
          Your Number. <br />
          Your Buyer. Direct.
        </h1>
      ...
      <section className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-3 md:gap-6">
          ...
          {[
            ...
            <div
              key={i}
              className="bg-[#F8FBF9] border border-[#E1EAE5] rounded-[14px] p-4 md:p-6"
            >
              {/* Number Badge */}
              <div className="bg-yellow-500/30 text-black text-[13px] font-semibold px-3 py-[2px] md:py-[4px] rounded-md inline-block mb-3 md:mb-4">
                {item.no}
              </div>

              {/* Title */}
              <h3 className="text-[18px] font-semibold text-[#1A1A1A] leading-6 md:leading-snug whitespace-pre-line mb-1 md:mb-2">
                {item.title}
              </h3>

              {/* Desc */}
              <p className="md:text-[16px] text-[14px] text-[#5F6F68] leading-5 md:leading-relaxed">
                {item.desc}
              </p>
            </div>
          ))}
      ...
      <section className="w-full px-6 md:px-24 py-6 md:py-12 bg-white">
        ...
        {/* Divider */}
        <div className="border-t border-[#E3E3E3] mb-4 md:mb-8"></div>
        ...
        <div className="flex flex-col gap-3 md:gap-6">
          {[
            ...
            <div
              key={i}
              className="relative bg-[#F7F7F7] border border-[#E5E5E5] rounded-2xl 
  ...
  py-5 sm:py-6 md:py-8"
    ...
    // sm:left-6 sm:top-8 
    md:left-2 md:top-2 
    text-[34px] sm:text-[40px] md:text-[48px] 
    font-serif text-[#D6D6D6]"
              >
                {item.no}
              </span>

              {/* Content */}
              <div className="pl-8 sm:pl-10 md:pl-0">
                <h3 className="text-[16px] sm:text-[18px] md:text-[20px] font-semibold text-[#1A1A1A] mb-2">
                  {item.title}
                </h3>

                <p className="text-[14px] sm:text-[15px] text-[#5F6F68] leading-relaxed">
                  {item.desc}
                </p>
              </div>
            </div>
  ...
  <table className="w-full border border-[#E5E5E5] border-collapse">
    ...
    <thead>
      <tr className="bg-[#121212] text-white text-left">
        <th className="px-6 py-4 text-[15px] font-semibold w-[30%]">
          Feature
        </th>

        <th className="px-3 py-4 text-[15px] font-semibold text-center">
    ...
    <tbody className="text-[15px]">
      {[
        ...
        [
          "Buyer calls you directly",
          "Via platform",
          "✔ Direct call",
        ],
        ["Inquiry quality filter", "None", "✔ Genuine only"],
        ["Extra manpower needed", "Yes", "✔ Never"],
        ["Dedicated catalog page", "No", "✔ Built for you"],
        ["Transparent pricing", "No", "✔ Always"],
      ].map((row, i) => (
        <tr key={i} className="border-t border-[#E5E5E5] bg-white">
      ...
      <section className="w-full bg-[#F4F6F5] px-6 md:px-24 py-7 md:py-16">
        ...
        {/* Quote Box */}
        <div className="relative bg-white rounded-xl px-10 py-5 md:py-10 mb-5 md:mb-10">
          {/* Left Accent */}
          ...
          {/* Subtext */}
          <p className="text-center text-[#5F6F68] text-[14px] mt-2 md:mt-3">
