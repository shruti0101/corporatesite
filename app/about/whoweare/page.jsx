        ...
        <div className="px-6 md:px-12">
          <div className="max-w-4xl">
            <h1 className="text-3xl md:text-5xl font-bold text-white leading-tight mb-2">
              ...
              <br />
              <span className="text-[#E67C29]">We built a growth engine.</span>
            </h1>
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="bg-white p-7 rounded-2xl shadow-md border border-gray-100">
            <p className="text-black sm:text-sm md:text-lg leading-5 md:leading-relaxed">
              Inquiry Bazaar was founded with one obsession — making sure the
              right buyer finds the right supplier. Not just visibility, but
              meaningful discovery that leads to real business.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#DFE8E6] py-5  lg:py-7 px-6 md:px-16">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-2 md:mb-7 max-w-3xl">
            ...
            <h2 className="text-black text-2xl md:text-3xl font-bold  md:mb-2">
              {" "}
              Born from the factory floor, not a boardroom.
            </h2>
          </div>
          <p className="text-black mb-4 md:mb-8 md:text-lg leading-6 md:leading-relaxed text-xxl">
            Our founder spent years inside India’s largest B2B platform, working
            closely with MSMEs, factory owners, and manufacturers across the
            country. What he saw wasn’t a technology problem — it was a
            visibility problem. Thousands of genuinely capable suppliers were
            invisible to buyers simply because they didn’t know how to rank.
            That insight didn’t stay in a notebook. It became Inquiry Bazaar.
          </p>
      ...
      <section className="py-6 lg:py-20 px-6 md:px-16">
        <div className="max-w-6xl mx-auto text-center mb-6 lg:mb-16">
          ...
          <p className="text-gray-800 text-md mt-2">
            We are not just building a platform. We are fighting for every MSME
            that ever lost a deal to a competitor with a better listing, not a
            better product. Our passion is simple and unshakeable: India’s
            manufacturers and factory owners are world-class. They just need the
            world to find them. Every feature we build, every tool we create,
            every ranking we improve — it all comes from that one fire inside
            us.
          </p>
        </div>
      ...
      <section className="bg-[#0B1F3A] text-white py-6 lg:py-20 px-6 md:px-16 text-center">
        <div className="max-w-4xl mx-auto">
          <p className="text-xl md:text-2xl font-semibold leading-relaxed mb-4">
            ...
            here to make sure ranking — not luck — decides who gets found.”
          </p>
      ...
      <section className="py-4 md:py-6 lg:py-15 px-6 md:px-16 ">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-3 md:mb-4">
            <span className="text-[#0D2865]">
              Other platforms list you. We give you verified inquires.
            </span>
          </h2>
          ...
          <p className="text-gray-800 text-md md:text-lg mb-6 md:mb-14">
            ...
            MSME expertise so your products get seen by people who are ready to
            buy.
          </p>
          ...
          <div className="grid md:grid-cols-3  gap-4 md:gap-8">
            ...
            flex flex-col items-center text-center group"
                >
                  ...
                  <p className="text-gray-800 mt-1 md:mt-3">{item.desc}</p>
                </div>
              );
            })}
          </div>
      ...
      <section className="py-6 md:py-10 px-6 md:px-16 bg-[#0B1F3A]">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-white/80 text-md md:text-lg leading-relaxed max-w-6xl mx-auto">
            We believe the next wave of Indian B2B growth will come from
            empowered MSMEs — manufacturers and suppliers who have the right
            tools, the right visibility, and the right buyers knocking on their
            door. Inquiry Bazaar is that door.
          </p>
        </div>
      </section>
      ...
      <section className="py-6 md:py-10 px-6 md:px-16 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-5xl mx-auto text-center mb-7 md:mb-20">
            ...
            <h2 className="text-2xl md:text-3xl font-semibold text-[#0B1F3A] leading-tight mb-3 md:mb-6">
              To become India’s most trusted B2B discovery platform — where
              every serious buyer finds the right supplier in minutes, not
              months.
            </h2>

            <p className="text-black max-w-full text-[16px]  leading-relaxed w-full ">
              We envision a future where no Indian manufacturer is invisible.
              Where a factory in Ludhiana reaches a buyer in Surat instantly.
              Where a fabricator in Rajkot competes on quality — not just on who
              spends more on ads. We are building the infrastructure that
              connects ambition with opportunity, across every industry, every
              city, and every product category in India. Inquiry Bazaar will be
              the platform where India’s supply chain comes alive.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 md:gap-10">
            {/* CARD 1 */}
            <div
              className="group relative p-4 md:p-8 rounded-2xl bg-white border border-gray-300 
        ...
        transition-all duration-500 hover:-translate-y-2"
            >
              ...
              <p className="text-black text-[15px] leading-relaxed">
                Connecting suppliers from every state to buyers across the
                country — and eventually, beyond borders.
              </p>
            </div>
        ...
        transition-all duration-500 hover:-translate-y-2"
            >
              ...
              <p className="text-black text-[15px] leading-relaxed">
                Building ranking technology that rewards quality, not just
                budget — so the best supplier wins, not the biggest spender.
              </p>
            </div>
        ...
        transition-all duration-500 hover:-translate-y-2"
            >
              ...
              <p className="text-black text-[15px] leading-relaxed">
                Equipping every small business with the digital tools,
                visibility, and confidence to grow without depending on
                middlemen.
              </p>
            </div>
          </div>
      ...
      <section className="bg-[#F7F6F2] py-8   px-6 md:px-16">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white flex flex-col rounded-2xl p-6 md:p-12 text-center shadow-[0_20px_60px_rgba(0,0,0,0.08)] border border-gray-100">
            ...
            <a
              className="underline text-black text-xl"
